...
static const _ButtonState_type_support_symbol_names_t _ButtonState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chest_interfaces, msg, ButtonState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chest_interfaces, msg, ButtonState)),
  }
};
...
{
  return &::chest_interfaces::msg::rosidl_typesupport_cpp::ButtonState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, chest_interfaces, msg, ButtonState)() {
  return get_message_type_support_handle<chest_interfaces::msg::ButtonState>();
}
