...
static const _VoiceText_type_support_symbol_names_t _VoiceText_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chest_interfaces, msg, VoiceText)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chest_interfaces, msg, VoiceText)),
  }
};
...
{
  return &::chest_interfaces::msg::rosidl_typesupport_cpp::VoiceText_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, chest_interfaces, msg, VoiceText)() {
  return get_message_type_support_handle<chest_interfaces::msg::VoiceText>();
}
