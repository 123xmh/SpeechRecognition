...
static const _ButtonState_type_support_symbol_names_t _ButtonState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chest_interfaces, msg, ButtonState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chest_interfaces, msg, ButtonState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chest_interfaces, msg, ButtonState)() {
  return &::chest_interfaces::msg::rosidl_typesupport_c::ButtonState_message_type_support_handle;
}
