...
#include <stddef.h>
#include "chest_interfaces/msg/detail/button_state__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  chest_interfaces__msg__ButtonState__init(message_memory);
}

void ButtonState__rosidl_typesupport_introspection_c__ButtonState_fini_function(void * message_memory)
{
  chest_interfaces__msg__ButtonState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ButtonState__rosidl_typesupport_introspection_c__ButtonState_message_member_array[8] = {
  {
    "header",  // name
    ...
    offsetof(chest_interfaces__msg__ButtonState, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, head_tracking_enabled),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, voice_command_enabled),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, front_screen_enabled),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, front_screen_mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, hmd_video_source),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, hmd_overlay_mode),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chest_interfaces__msg__ButtonState, hmd_enabled),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ButtonState__rosidl_typesupport_introspection_c__ButtonState_message_members = {
  ...
  8,  // number of fields
  sizeof(chest_interfaces__msg__ButtonState),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chest_interfaces, msg, ButtonState)() {
  ButtonState__rosidl_typesupport_introspection_c__ButtonState_message_member_array[0].members_ =
