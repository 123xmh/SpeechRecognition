...
bool chest_interfaces__msg__equipment_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("chest_interfaces.msg._equipment_state.EquipmentState", full_classname_dest, 52) == 0);
  }
  chest_interfaces__msg__EquipmentState * ros_message = _ros_message;
  {  // ammo_types
    PyObject * field = PyObject_GetAttrString(_pymsg, "ammo_types");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'ammo_types'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->ammo_types.data;
  ...
  {  // ammo_counts
    PyObject * field = PyObject_GetAttrString(_pymsg, "ammo_counts");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->ammo_counts.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'ammo_counts'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // gimbal_yaw
    ...
    assert(PyFloat_Check(field));
    ros_message->gimbal_yaw = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // gimbal_is_active
    PyObject * field = PyObject_GetAttrString(_pymsg, "gimbal_is_active");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->gimbal_is_active = (Py_True == field);
    Py_DECREF(field);
  }
  {  // longitude
  ...
  {  // ground_altitude
    PyObject * field = PyObject_GetAttrString(_pymsg, "ground_altitude");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->ground_altitude = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // heading
  ...
  {  // state_names
    PyObject * field = PyObject_GetAttrString(_pymsg, "state_names");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'state_names'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->state_names.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // state_values
    PyObject * field = PyObject_GetAttrString(_pymsg, "state_values");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->state_values.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'state_values'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of EquipmentState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("chest_interfaces.msg._equipment_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EquipmentState");
  ...
  {  // ammo_types
    ...
    rosidl_runtime_c__String * src = ros_message->ammo_types.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "ammo_types", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ammo_counts
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "ammo_counts");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->ammo_counts.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->ammo_counts.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->ammo_counts.size * sizeof(uint8_t));
      assert(data != NULL);
  ...
  {  // gimbal_is_active
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->gimbal_is_active ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "gimbal_is_active", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // ground_altitude
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->ground_altitude);
    {
      int rc = PyObject_SetAttrString(_pymessage, "ground_altitude", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // state_names
    ...
    rosidl_runtime_c__String * src = ros_message->state_names.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "state_names", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // state_values
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "state_values");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->state_values.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->state_values.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->state_values.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
